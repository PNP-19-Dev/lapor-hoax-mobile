...
// in laporhoax/test/presentation/provider/news_detail_notifier.dart.
...
import 'package:laporhoax/domain/usecases/get_feed_detail.dart' as _i11;
import 'package:laporhoax/domain/usecases/get_feed_save_status.dart' as _i9;
import 'package:laporhoax/domain/usecases/get_saved_feeds.dart' as _i10;
import 'package:laporhoax/domain/usecases/remove_feed.dart' as _i8;
import 'package:laporhoax/domain/usecases/save_feed.dart' as _i4;
...
class MockSaveFeed extends _i1.Mock implements _i4.SaveFeed {
  MockSaveFeed() {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoveFeed extends _i1.Mock implements _i8.RemoveFeed {
  MockRemoveFeed() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetFeedSaveStatus extends _i1.Mock implements _i9.GetFeedSaveStatus {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetSavedFeeds extends _i1.Mock implements _i10.GetSavedFeeds {
  MockGetSavedFeeds() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetFeedDetail extends _i1.Mock implements _i11.GetFeedDetail {
  MockGetFeedDetail() {
    _i1.throwOnMissingStub(this);
  }
