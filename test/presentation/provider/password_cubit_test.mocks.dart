...
// in laporhoax/test/presentation/provider/password_cubit_test.dart.
...
import 'package:laporhoax/domain/usecases/get_password_reset.dart' as _i7;
import 'package:laporhoax/domain/usecases/get_user.dart' as _i8;
import 'package:laporhoax/domain/usecases/post_change_password.dart' as _i4;
...
class MockPostChangePassword extends _i1.Mock
    implements _i4.PostChangePassword {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetPasswordReset extends _i1.Mock implements _i7.GetPasswordReset {
