...
import 'package:laporhoax/domain/entities/session_data.dart' as _i12;
...
import 'package:laporhoax/domain/usecases/get_session_data.dart' as _i11;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetSessionData extends _i1.Mock implements _i11.GetSessionData {
  MockGetSessionData() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i12.SessionData?>> execute() =>
      (super.noSuchMethod(Invocation.method(#execute, []),
          returnValue: Future<_i3.Either<_i6.Failure, _i12.SessionData?>>.value(
              _FakeEither_1<_i6.Failure, _i12.SessionData?>())) as _i5
          .Future<_i3.Either<_i6.Failure, _i12.SessionData?>>);
  @override
  String toString() => super.toString();
}
...
class MockRemoveSessionData extends _i1.Mock implements _i13.RemoveSessionData {
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<String> execute(_i12.SessionData? data) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSessionData extends _i1.Mock implements _i12.SessionData {
  MockSessionData() {
    _i1.throwOnMissingStub(this);
  }
