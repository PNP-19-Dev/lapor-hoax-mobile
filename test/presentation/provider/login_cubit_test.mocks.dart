...
import 'package:laporhoax/domain/usecases/get_session_data.dart' as _i10;
...
import 'package:laporhoax/domain/usecases/set_session.dart' as _i12;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetSessionData extends _i1.Mock implements _i10.GetSessionData {
  MockGetSessionData() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [SetSession].
///
/// See the documentation for Mockito's code generation for more information.
class MockSetSession extends _i1.Mock implements _i12.SetSession {
  MockSetSession() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<bool> execute({_i11.SessionData? data}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#data: data}),
