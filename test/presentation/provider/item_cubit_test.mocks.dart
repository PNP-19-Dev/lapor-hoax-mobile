...
// in laporhoax/test/presentation/provider/item_cubit_test.dart.
...
import 'package:laporhoax/domain/usecases/get_feed_save_status.dart' as _i4;
import 'package:laporhoax/domain/usecases/remove_feed.dart' as _i9;
import 'package:laporhoax/domain/usecases/save_feed.dart' as _i6;
import 'package:laporhoax/utils/failure.dart' as _i7;
...
class MockGetFeedSaveStatus extends _i1.Mock implements _i4.GetFeedSaveStatus {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveFeed extends _i1.Mock implements _i6.SaveFeed {
  MockSaveFeed() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<_i3.Either<_i7.Failure, String>> execute(_i8.Feed? feed) =>
