...
import 'package:laporhoax/domain/entities/session_data.dart' as _i13;
...
class MockSaveSessionData extends _i1.Mock implements _i12.SaveSessionData {
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<String> execute(_i13.SessionData? data) =>
...
class MockGetSessionData extends _i1.Mock implements _i14.GetSessionData {
  ...
  _i2.Repository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeRepository_0()) as _i2.Repository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i13.SessionData?>> execute() =>
      (super.noSuchMethod(Invocation.method(#execute, []),
          returnValue: Future<_i3.Either<_i6.Failure, _i13.SessionData?>>.value(
              _FakeEither_1<_i6.Failure, _i13.SessionData?>())) as _i5
          .Future<_i3.Either<_i6.Failure, _i13.SessionData?>>);
  @override
  String toString() => super.toString();
}
