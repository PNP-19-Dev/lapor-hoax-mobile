...
void main() {
  ...
  group('Get Feed Detail', () {
    ...
    test(
      ...
      expect(result, equals(Right(tfeedResponse)));
    });
    test(
        'should return Server Failure when the call to remote data source is unsuccessful',
        () async {
  ...
  group('Remove Session Data', () {
    ...
    test('should return No Data when remove unsuccessful', () async {
      // arrange
      when(mockLocalDataSource.removeFeed(testFeedTable))
          .thenThrow(CustomException('No Data'));
      // act
      final result = await repository.removeFeed(testFeed);
      // assert
  ...
  group('Save Feed', () {
    ...
    test('should return DatabaseFailure when saving unsuccessful', () async {
      ...
      final result = await repository.saveFeed(testFeed);
      // assert
      expect(result, Left(DatabaseFailure('Failed to add Feed')));
    });
  });
  group('Save Session Data', () {
    ...
    test('should return No Data when saving unsuccessful', () async {
      // arrange
      when(mockLocalDataSource.insertSession(testSessionData))
          .thenThrow(CustomException('No Data'));
      // act
