...
import '../../utils/network_info_impl.dart';
...
class RepositoryImpl implements Repository {
  ...
  Future<Either<Failure, List<Feed>>> getFeeds() async {
    try {
      ...
      return const Left(ServerFailure('Cant Retrieve Feed Data'));
    } on SocketException {
  ...
  Future<Either<Failure, List<Category>>> getCategories() async {
    if (await networkInfo.isConnected) {
      try {
        ...
        return const Left(ServerFailure("Cant Fetch Categories"));
      } on SocketException {
        return const Left(ConnectionFailure("Failed to connect to the network"));
      }
    } else {
  ...
  Future<Either<Failure, List<Report>>> getReports(String token, int id) async {
    try {
      ...
      return const Left(ServerFailure("Cant Fetch Reports"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, Report>> postReport(
    ...
    try {
      ...
      return const Left(ServerFailure("Invalid"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, String>> deleteReport(String token, int id) async {
    try {
      ...
      return const Left(ServerFailure("Cant Delete Report"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, String>> getPasswordReset(String email) async {
    try {
      ...
      return const Left(ServerFailure("Cant Reset"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, List<Question>>> getQuestions() async {
    if (await networkInfo.isConnected) {
      try {
        ...
        return const Left(ServerFailure("Cant Retrieve Data"));
      } on SocketException {
        return const Left(ConnectionFailure("Failed to connect to the network"));
      }
    } else {
  ...
  Future<Either<Failure, String>> postChangePassword(
    ...
    try {
      ...
      return const Left(ServerFailure("Cant Change Password"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, String>> postFCMToken(
    ...
    try {
      ...
      return const Left(ServerFailure("Cant To Send"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
  ...
  Future<Either<Failure, SessionData>> getSessionData() async {
    ...
    if (result != null) {
      ...
      return const Left(CustomException('No Data'));
    }
  }
  ...
  Future<Either<Failure, Feed>> getFeedDetail(int id) async {
    try {
      ...
      return const Left(ServerFailure("Failed To Get Detail"));
    } on SocketException {
      return const Left(ConnectionFailure("Failed to connect to the network"));
    }
  }
